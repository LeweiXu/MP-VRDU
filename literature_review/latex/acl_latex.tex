...
The training-free machinery surveyed in \S\ref{sec:trainingfree} is increasingly elaborate, yet headline accuracy on the field's long-document benchmarks~\cite{ma2024mmlongbench,deng2025longdocurl} remains well below human performance, and the strongest published systems cluster near a shared ceiling rather than separating sharply. The problems below account for much of that remaining gap and are ordered by how directly improvement on each would register on shared benchmarks.
