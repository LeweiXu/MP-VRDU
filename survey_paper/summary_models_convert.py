...
Usage:
    python3 summary_models_convert.py [input.csv] [output.tex]
...
INPUT_CSV   = sys.argv[1] if len(sys.argv) > 1 else str(BASE_DIR / "models" / "models_summary.csv")
_out_base   = sys.argv[2] if len(sys.argv) > 2 else str(BASE_DIR / "models" / "models_summary")
...
def main():
    ...
    arch_caption = (
        ...
        r"T\,=\,text; V\,=\,visual; L\,=\,layout. "
        r"CoT\,=\,Chain of Thought; ReAct\,=\,Reason\,+\,Act; "
        r"PE\,=\,Plan-Execute; QD\,=\,Question Decomposition; HD\,=\,Hierarchical / Coarse-to-Fine. "
        r"S\,=\,Sparse; D\,=\,Dense; J\,=\,Joint; "
    ...
    if ocr_col:
        ...
        ocr_caption = (
            r"Survey of MP-VRDU models grouped by OCR dependency. "
            r"PDT\,=\,Page-to-Document Encoding Models; "
            r"BC\,=\,Backbone-Centric MLLM Adaptation; "
            r"RAG\,=\,Retriever-Generator Pipeline; AP\,=\,Agentic Pipeline. "
            r"T\,=\,text; V\,=\,visual; L\,=\,layout. "
            r"CoT\,=\,Chain of Thought; ReAct\,=\,Reason\,+\,Act; "
            r"PE\,=\,Plan-Execute; QD\,=\,Question Decomposition; HD\,=\,Hierarchical / Coarse-to-Fine. "
            r"S\,=\,Sparse; D\,=\,Dense; J\,=\,Joint; "
